...
var CONTENT_DEFAULTS = {
  en: {
    ...
    'hero.scroll':          'Scroll',
    'section.num.services':  '01 / Services',
    'section.num.tracking':  '02 / Tracking',
    'section.num.partners':  '03 / Partners',
    'section.num.projects':  '04 / Projects',
    'section.num.about':     '05 / About',
    'section.num.quality':   '06 / Quality',
    'section.num.team':      '07 / Team',
    'section.num.contact':   '08 / Contact',
    'stat.1.n':           '€11M+',
    ...
    'contact.tc.mapq':          'Osogovo st. 51, 1303 Sofia, Bulgaria',
    ...
    'contact.form.inquiryto':        'Inquiry to',
    'contact.form.inquiry.technocon':'Technocon',
    ...
    'contact.form.message.ph':       'Describe your project requirements…',
    'projects.cta':                  'View Project',
    'quality.cert.cta':              'View certificate →',
    'cookie.text':    'We use cookies to analyse site traffic via Google Analytics. No personal data is shared with third parties. See our',
  ...
  bg: {
    ...
    'hero.scroll':          'Скролирай',
    'section.num.services':  '01 / Услуги',
    'section.num.tracking':  '02 / Проследяване',
    'section.num.partners':  '03 / Партньори',
    'section.num.projects':  '04 / Проекти',
    'section.num.about':     '05 / За нас',
    'section.num.quality':   '06 / Качество',
    'section.num.team':      '07 / Екип',
    'section.num.contact':   '08 / Контакт',
    'stat.1.n':           '€11M+',
    ...
    'contact.phone2':     '+359 88 8304414',
    'contact.web':        'www.techno-con.eu',
    'contact.form.inquiryto':        'Запитване до',
    'contact.form.inquiry.technocon':'Техноcon',
    'contact.form.inquiry.subver':   'Subver',
    'contact.form.firstname':        'Собствено Ime',
    ...
    'contact.form.firstname.ph':     'Иван',
    'contact.form.lastname.ph':      'Иванов',
    'contact.form.company.ph':       'Компания',
    'contact.form.email.ph':         'ivan@company.com',
    'contact.form.message.ph':       'Опишете вашите изисквания…',
    'projects.cta':                  'Виж проекта',
    'quality.cert.cta':              'Виж сертификата →',
    'cookie.text':    'Използваме бисквитки за анализ на трафика чрез Google Analytics. Никакви лични данни не се споделят с трети страни. Вижте нашата',
    'cookie.link':    'Политика за поверителност',
    'cookie.decline': 'Отказ',
